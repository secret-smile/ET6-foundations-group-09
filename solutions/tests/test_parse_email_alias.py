...
class TestParseEmailAlias(unittest.TestCase):
    ...
    def test_multiple_tags(self):
        ...
        """
        self.assertEqual(parse_email_alias("user+tag1+tag2@example.com")['tags'], ['tag1', 'tag2'])
    ...
    def test_subdomain(self):
        ...
        """
        self.assertEqual(parse_email_alias("user@sub.example.com")['domain'], 'sub.example.com')
    ...
    def test_invalid_characters_in_local_part(self):
        ...
        """
        self.assertIn("Invalid characters in local part", parse_email_alias("user<>@example.com")['errors'])
    ...
    def test_missing_top_level_domain(self):
        ...
        """
        self.assertIn("Invalid domain (missing TLD)", parse_email_alias("user@sub.")['errors'])
    ...
    def test_invalid_domain_format(self):
        ...
        """
        self.assertIn("Invalid domain format", parse_email_alias("user@[192.168.1.1]")['errors'])
